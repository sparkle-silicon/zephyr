 ...
 *
 * @file spi_flash.h
 * @brief AE201 外部 SPI NOR Flash 驱动接口（模板）。
 *
 * ⚠️ 重定位约束：下列函数在 Flash 擦写期间被执行。因 AE201 ICACHE 采用
...
#ifndef ZEPHYR_SOC_RISCV_SPKSILICON_AE201_SPI_FLASH_H_
#define ZEPHYR_SOC_RISCV_SPKSILICON_AE201_SPI_FLASH_H_
...
#endif /* ZEPHYR_SOC_RISCV_SPKSILICON_AE201_SPI_FLASH_H_ */
